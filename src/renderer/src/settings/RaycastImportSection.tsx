...
const IMPORT_CATEGORY_META: Array<{
  ...
  { key: 'commandHotkeys', title: 'Command hotkeys', description: 'Per-command hotkeys mapped onto Discov commands.', icon: <Command className="w-4 h-4" />, countKey: 'commandHotkeys' },
  ...
  { key: 'aiChats', title: 'AI chats', description: 'Conversation history mapped into the existing Discov chat UI.', icon: <BrainCircuit className="w-4 h-4" />, countKey: 'aiChats' },
  ...
  { key: 'notes', title: 'Notes', description: 'Raycast notes imported into Discov notes.', icon: <StickyNote className="w-4 h-4" />, countKey: 'notes' },
